...
import EmployeeMobileCard from '../components/EmployeeMobileCard.vue'
        ...
        <template v-else>
          <div v-if="filteredEmployees.length" class="hidden md:block">
            ...
            >
              ...
              <Column field="title" header="Jabatan" sortable style="min-width: 190px">
                <template #body="{ data }: { data: Employee }">
                  <div>
              ...
              <Column field="city" header="Lokasi" sortable style="min-width: 130px">
                <template #body="{ data }: { data: Employee }">
